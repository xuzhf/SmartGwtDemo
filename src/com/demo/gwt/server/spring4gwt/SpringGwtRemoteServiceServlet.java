...
/**
 * copy from google，在其中把它的request和response取出来设置到了ThreadLocalAware中去
 * @author xiaoZhao
 */
...
public class SpringGwtRemoteServiceServlet extends RemoteServiceServlet {
	...
	protected Object getBean(HttpServletRequest request) {
		...
		threadLocal.setThreadLocalRequest(this.getThreadLocalRequest());
		threadLocal.setThreadLocalResponse(this.getThreadLocalResponse());
		threadLocal.setServletContext(this.getServletContext());
